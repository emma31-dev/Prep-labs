...
const LoginModal = ({ onRegister }: LoginModalProps) => {
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-16">
          <div className="max-w-md mx-auto">
            ...
            <p className="mb-8" style={{ color: '#737373' }}>
              Sign in to access your AI test generator and saved question banks.
            </p>

            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="username" className="font-medium" style={{ color: '#171717' }}>
                  Username
                </Label>
                <Input
                  id="username"
